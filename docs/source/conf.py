...
Notes:
    ...
    cd ~/code/kwplot/docs
    sphinx-apidoc -f -o ~/code/kwplot/docs/source ~/code/kwplot/kwplot --separate
    make html
...
def process_docstring(app, what_: str, name: str, obj: Any, options: Any, lines:
                   List[str]) -> None:
    """
