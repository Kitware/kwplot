...
Notes:
    ...
    cd ~/code/kwplot/docs
    sphinx-apidoc --private -f -o ~/code/kwplot/docs/source ~/code/kwplot/kwplot --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/kwplot/advanced/
        ...
        For gitlab you also need to setup an integrations. Navigate to:
            ...
            https://readthedocs.org/dashboard/kwplot/integrations/create/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/kwplot/versions/
"""
#
...
modpath = join(dirname(dirname(dirname(__file__))), 'kwplot', '__init__.py')
...
# html_logo = '.static/kwplot.svg'
# html_favicon = '.static/kwplot.ico'
...
latex_documents = [
    (master_doc, 'kwplot.tex', 'kwplot Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'kwplot', 'kwplot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kwplot', 'kwplot Documentation',
     author, 'kwplot', 'One line description of project.',
     'Miscellaneous'),
]
