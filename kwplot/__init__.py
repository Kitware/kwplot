...
from .mpl_core import (distinct_colors, distinct_markers, ensure_fnum, figure,
                       ...
                       show_if_requested,)
from .mpl_draw import (draw_boxes, draw_line_segments, plot_matrix,)
...
__all__ = ['Color', 'PlotNums', 'auto_backends', 'autompl', 'distinct_colors',
           'distinct_markers', 'draw_boxes', 'draw_conv', 'draw_line_segments',
           'ensure_fnum', 'figure', 'imshow', 'legend', 'make_conv_images',
           'make_heatmask', 'make_orimask', 'make_vector_field', 'mpl_color',
           'mpl_core', 'mpl_draw', 'mpl_make', 'mpl_multiplot', 'mpl_plotnums',
           'multi_plot', 'next_fnum', 'plot_convolutional_features',
           'plot_matrix', 'set_figtitle', 'set_mpl_backend',
           'show_if_requested']
